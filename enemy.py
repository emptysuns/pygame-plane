...
class MidEnemy(pygame.sprite.Sprite):
    ...
    def __init__(self, bg_size):
        ...
        self.image_hit = pygame.image.load("img/enemy2_hit.png").convert_alpha()
        self.destory_images = []
        self.destory_images.extend([\
            pygame.image.load("img/enemy2_down1.png").convert_alpha(),\
...
class BigEnemy(pygame.sprite.Sprite):
    ...
    def __init__(self, bg_size):
        ...
        self.image2 = pygame.image.load("img/enemy3_n2.png").convert_alpha()
        self.image_hit = pygame.image.load("img/enemy3_hit.png").convert_alpha()
        self.destory_images = []
        self.destory_images.extend([\
            pygame.image.load("img/enemy3_down1.png").convert_alpha(),\
